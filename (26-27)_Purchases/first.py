...
month_map = [
    "April'26","May'26", "Jun'26", "Jul'26", "Aug'26","Sep'26", 
...
business_dict = {
    ...
    "Market Linkages Value Intervention": [
...
def purchase():
    print("before")
    product_quantity = pd.read_excel("/home/thrymr/Downloads/apr_pivot.xlsx", sheet_name="Product Qty")
   
    product_gross = pd.read_excel("/home/thrymr/Downloads/apr_pivot.xlsx", sheet_name="Taxable value")
    ...
    print(len(rows))                
    df.to_excel("/home/thrymr/Downloads/apr.xlsx")
    print("completed")
