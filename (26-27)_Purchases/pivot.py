...
def create_sales_pivot(input_file_path, output_file_path):
    ...
    essential_cols = ['Date', 'Sub Vertical', 'Product Name', 'HSN Code',
                     ...
                     'District', 'Helper Qty', 'Helper Taxable']
    ...
    # Create pivot table for quantities (source column: Helper Qty)
    ...
    # Create pivot table for taxable values (source column: Helper Taxable)
    value_pivot = df_clean.pivot_table(
        index=base_cols,
        columns='District',
        values='Helper Taxable',
        aggfunc='sum',
        fill_value=0
    ).reset_index()
    ...
    with pd.ExcelWriter(output_file_path, engine='openpyxl') as writer:
        # Sheet 1: Quantities (sheet name: "Product Qty")
...
OUTPUT_PATH = "/home/thrymr/Downloads/apr_pivot.xlsx"

if __name__ == "__main__":
    input_files = [
        "/home/thrymr/Desktop/sales 26-27/cleanes_sales_received_from_hari/cons_Apr 26 W Sales- For review.xlsx",
        "/home/thrymr/Desktop/sales 26-27/apr_agri_cleaned_sale_26-27.xlsx"
