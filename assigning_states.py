...
df = pd.read_excel("/home/thrymr/Downloads/second_March.xlsx")  # replace with your actual file path
...
df["customer_state"] = df["District"].str.strip().str.lower().map(district_to_state)

# Step 5 (Optional): Save or display result
df.to_excel("/home/thrymr/Downloads/March_with_states.xlsx", index=False)
print(df.head())
