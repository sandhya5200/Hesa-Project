...
sep1 = pd.read_excel("/home/thrymr/Desktop/sales 25-26/sales_with_hesaathis_part1.xlsx")
sep2 = pd.read_excel("/home/thrymr/Desktop/sales 25-26/sales_with_hesaathis_part2.xlsx")
...
# Save or display
df_sorted.to_excel("/home/thrymr/Downloads/analyzed_report_10.xlsx", index=False)
print(df_sorted)
