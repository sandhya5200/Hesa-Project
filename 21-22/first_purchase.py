...
def purchase():
    print("before")
    product_quantity = pd.read_excel("/home/thrymr/Downloads/sheets_split/month_wise_files/April_2021.xlsx", sheet_name="Products")
   
    product_gross = pd.read_excel("/home/thrymr/Downloads/sheets_split/month_wise_files/April_2021.xlsx", sheet_name="Taxable")
    ...
    print(len(rows))                
    df.to_excel("/home/thrymr/Downloads/April.xlsx")
    print("completed")
