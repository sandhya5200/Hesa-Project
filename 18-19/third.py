...
sales_df = pd.read_excel("/home/thrymr/Downloads/products_cons_mar.xlsx")
...
sales_df.to_excel("/home/thrymr/Downloads/mar_sales_with_hesaathis.xlsx", index=False)
