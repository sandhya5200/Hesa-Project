...
# Load input file
input_df = pd.read_excel("/home/thrymr/Downloads/Mar_final.xlsx")  # Change to .csv if needed
...
# Save to Excel
final_df.to_excel("/home/thrymr/Downloads/Mar_purchase_with_vendors.xlsx", index=False)
