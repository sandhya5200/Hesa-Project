...
def create_pdf_with_borders(file_path, logo_path, signature_path, data):
    ...
    for invoice_number, group in grouped_data:
        ...
        if hesathi_code in hesathi_mapping:
            ...
            village = str(village) if pd.notna(village) else ""
        ...
        # Ensure the value is a string and replace NaN with an empty string
        customer_district = str(customer_district) if pd.notna(customer_district) else ""
        c.drawString(middle_x + 0.1 * inch, middle_c - 0.75 * inch, customer_district)
        ...
        if customer_pincode is None or (isinstance(customer_pincode, float) and isnan(customer_pincode)):
            ...
            formatted_pincode = str(customer_pincode)  
...
#     '/home/thrymr/Desktop/input Files(24-25)/processed_agri_sales_Sep_24.xlsx',
...
#     final_pdf_path = f"/home/thrymr/Desktop/Invoices(2024-25)/invoice_{pdf_file_name}"
...
monthly_folder = "/home/thrymr/Desktop/input Files(24-25)/Sept"  # update this to actual folder path
...
pdf_file_name = "invoice_Sept_24_combined.pdf"
final_pdf_path = f"/home/thrymr/Desktop/Invoices(2024-25)/{pdf_file_name}"
