...
input_file = '/home/thrymr/Downloads/filtered_mod_telangana.xlsx'
additional_info_file = '/home/thrymr/Desktop/Statewise_customerdata/Telangana_original.xlsx'
...
districts = [
    # 'ADILABAD', 'HYDARABAD', 'KARIM NAGAR', 'KHAMMAM', 'MAHABUB NAGAR',
    # 'MEDAK', 'NALGONDA', 'NIZAMABAD', 'RANGAREDDY', 'SANGAREDDY',
    # 'VIKARABAD', 'WANAPARTHY', 'WARANGAL'

    'Damarakunta','Itikyal','Aliyabad','Alirajpet','Lingareddy Pally','Kesavaram','Varadarajapuram','Pothaaram','Kolthur','Mudu Chintala Palli',
    'Karkapatla','Shameerpet', 'Laxmapur', 'Raipole'
]
...
output_file = '/home/thrymr/Downloads/Telangana_Vendor_Database.xlsx'
